...
export function interpretRectCorner(
  ...
  if (rect.cornerRadius.all === undefined) {
    borderRadius = BorderRadius.only({
      topLeft:
        rect.cornerRadius.tl == 0
          ? undefined
          : interpretRadius(rect.cornerRadius.tl),
      topRight:
        rect.cornerRadius.tr == 0
          ? undefined
          : interpretRadius(rect.cornerRadius.tr),
      bottomLeft:
        rect.cornerRadius.bl == 0
          ? undefined
          : interpretRadius(rect.cornerRadius.bl),
      bottomRight:
        rect.cornerRadius.br == 0
          ? undefined
          : interpretRadius(rect.cornerRadius.br),
    });
  } else {
