...
// alias
const flag_key__as_heading5 = "as-heading5";
const flag_key__as_headline5 = "as-headline5";
const flag_key__h5 = "h5";
const flag_key__heading5 = "heading5";
const flag_key__headline5 = "headline5";
