import type { mixed, Stringish } from "../_";
import type {
  RNReactNode,
  RNMouseEvent,
  RNPressEvent,
...
type RNBubblingEventProps = Readonly<{
  ...
  onFocus?: (event: RNFocusEvent) => mixed;
}>;

type RNDirectEventProps = Readonly<{
  /**
   * When `accessible` is true, the system will try to invoke this function
   * when the user performs an accessibility custom action.
   *
   */
  onAccessibilityAction?: (event: RNAccessibilityActionEvent) => mixed;
   ...
   */
  onLayout?: (event: RNLayoutEvent) => mixed;
...
type RNMouseEventProps = Readonly<{
  onMouseEnter?: (event: RNMouseEvent) => void;
  onMouseLeave?: (event: RNMouseEvent) => void;
}>;

type RNTouchEventProps = Readonly<{
  onTouchCancel?: (e: RNPressEvent) => void;
  onTouchCancelCapture?: (e: RNPressEvent) => void;
  onTouchEnd?: (e: RNPressEvent) => void;
  onTouchEndCapture?: (e: RNPressEvent) => void;
  onTouchMove?: (e: RNPressEvent) => void;
  onTouchMoveCapture?: (e: RNPressEvent) => void;
  onTouchStart?: (e: RNPressEvent) => void;
  onTouchStartCapture?: (e: RNPressEvent) => void;
}>;

type RNPointerEvents = "auto" | "box-none" | "box-only" | "none";

type RNAndroidDrawableThemeAttr = Readonly<{
  type: "ThemeAttrAndroid";
  attribute: string;
}>;

type RNAndroidDrawableRipple = Readonly<{
  type: "RippleAndroid";
  color?: number;
  borderless?: boolean;
  rippleRadius?: number;
...
type RNAndroidDrawable = RNAndroidDrawableThemeAttr | RNAndroidDrawableRipple;

type RNAndroidViewProps = Readonly<{
  nativeBackgroundAndroid?: RNAndroidDrawable;
  nativeForegroundAndroid?: RNAndroidDrawable;
   ...
   * @platform android
   */
  onClick?: (event: RNPressEvent) => mixed;
}>;

type RNIOSViewProps = Readonly<{
  /**
 ...
 */
type RNGestureResponderEventProps = Readonly<{
  /**
   ...
   */
  onMoveShouldSetResponder?: (e: RNPressEvent) => boolean;
   ...
   */
  onMoveShouldSetResponderCapture?: (e: RNPressEvent) => boolean;
   ...
   */
  onResponderGrant?: (e: RNPressEvent) => void | boolean;
   ...
   */
  onResponderMove?: (e: RNPressEvent) => void;
   ...
   */
  onResponderReject?: (e: RNPressEvent) => void;
   ...
   */
  onResponderRelease?: (e: RNPressEvent) => void;

  onResponderStart?: (e: RNPressEvent) => void;
  onResponderEnd?: (e: RNPressEvent) => void;
   ...
   */
  onResponderTerminate?: (e: RNPressEvent) => void;
   ...
   */
  onResponderTerminationRequest?: (e: RNPressEvent) => boolean;
   ...
   */
  onStartShouldSetResponder?: (e: RNPressEvent) => boolean;
   ...
   */
  onStartShouldSetResponderCapture?: (e: RNPressEvent) => boolean;
}>;
